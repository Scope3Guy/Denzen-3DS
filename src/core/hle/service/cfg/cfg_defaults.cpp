...
constexpr std::array<u8, 2> DEFAULT_TWL_EULA_INFO = {0x7F, 0x7F};
constexpr std::array<u8, 0x94> DEFAULT_TWL_PARENTAL_RESTRICTIONS = {};
constexpr u8 DEFAULT_TWL_COUNTRY_CODE = UNITED_STATES_COUNTRY_ID;
constexpr u32_le DEFAULT_QTM_INFRARED_LED_RELATED = 0;
constexpr std::array<u8, 0x18> DEFAULT_QTM_CALIBRATION_DATA = {};
...
static const std::unordered_map<ConfigBlockID, ConfigBlockDefaults> DEFAULT_CONFIG_BLOCKS = {
    ...
    {TwlEulaInfoBlockID,
     {AccessFlag::System, &DEFAULT_TWL_EULA_INFO, sizeof(DEFAULT_TWL_EULA_INFO)}},
    ...
    {TwlCountryCodeBlockID,
     {AccessFlag::System, &DEFAULT_TWL_COUNTRY_CODE, sizeof(DEFAULT_TWL_COUNTRY_CODE)}},
    {QtmInfraredLedRelatedBlockID,
     {AccessFlag::System, &DEFAULT_QTM_INFRARED_LED_RELATED,
      sizeof(DEFAULT_QTM_INFRARED_LED_RELATED)}},
    {QtmCalibrationDataBlockID,
     {AccessFlag::System, &DEFAULT_QTM_CALIBRATION_DATA,
      sizeof(DEFAULT_QTM_CALIBRATION_DATA)}},
};
